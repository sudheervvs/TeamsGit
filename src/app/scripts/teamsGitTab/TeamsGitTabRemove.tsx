...
export interface ITeamsGitTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITeamsGitTabRemoveProps {

}

/**
 * Implementation of TeamsGit Tab remove page
 */
export class TeamsGitTabRemove  extends TeamsBaseComponent<ITeamsGitTabRemoveProps, ITeamsGitTabRemoveState> {
