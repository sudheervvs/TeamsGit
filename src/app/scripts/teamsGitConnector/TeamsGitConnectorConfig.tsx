...
export interface ITeamsGitConnectorConfigState extends ITeamsBaseComponentState {
...
export interface ITeamsGitConnectorConfigProps {
}
...
/**
 * Implementation of the teamsGitConnector Connector connect page
 */
export class TeamsGitConnectorConfig extends TeamsBaseComponent<ITeamsGitConnectorConfigProps, ITeamsGitConnectorConfigState> {
        ...
        if (await this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/teamsGitConnector/config.html?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}`,
