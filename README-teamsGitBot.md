...
3. Give the bot a handle (ex: `teamsGitBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://gitwithteams.azurewebsites.net/api/messages`
